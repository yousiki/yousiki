...
function renderBadge(label, value) {
  // 240 × 52 consistent Claude-palette badge
  return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 240 52" role="img" aria-label="${esc(label)}: ${esc(value)}" width="240" height="52">
  <defs>
  ...
  <rect width="240" height="52" rx="10" fill="url(#bBg)" stroke="#D97757" stroke-opacity="0.28"/>
  <path d="M18 26 L20 20 L26 18 L20 16 L18 10 L16 16 L10 18 L16 20 Z" fill="#D97757"/>
  <text x="36" y="22" class="mono" fill="#5E5D59" font-size="10" letter-spacing="1.6">${esc(label)}</text>
  <text x="36" y="40" class="serif" fill="#141413" font-size="17" font-weight="500" letter-spacing="-0.3">${esc(value)}</text>
</svg>
`;
}
